...
// Mengecek apakah tombol pencarian diklik
...
if (!isset($_GET['id'])) {
    ...
    $btn = 'Add';   // Label tombol 'Add'
    $title = 'Add'; // Judul halaman 'Add'
}

$view = new Template('templates/skintabel.html');   // Membuat objek Template
$mainTitle = 'Position';                            // Judul utama halaman 'Position'
$header = '<tr>
<th scope="row">No.</th>
...
$data = null;
$no = 1;
$formLabel = 'Position';                            // Label formulir 'Position'
...
if (isset($_GET['id'])) {
    ...
    if ($id > 0) {
        ...
        $title = 'Update';                  // Judul halaman 'Update'
